...
<body>
  ...
  <a href="AddProduct"><h4 align="right"><button type="button" class="btn btn-info btn-lg"> Add New Product</button></h4></a>
<h1 align="center"  style="background-color:;"><transparent>Product List</transparent></h1> 
<div class="row">
