...
<body>
<div class="container">
	<h2 align="center" style="background-color:;"><transparent>Add Product</transparent></h2>
    ...
    <form:hidden path="productId" />
		...
		<form:textarea path="productDesc"  class="form-control" style="width:750px"  placeholder="Enter Product  Description "/>
        </div>
        
        <div class="form-group">
		<form:label path="quantity"> Quantity :</form:label>
		<form:textarea path="quantity"  class="form-control" style="width:750px" placeholder="Enter Product Quantity "/>
